...
const assets={};
for(const name of ['index.html','styles.css','app.js','admin.html','admin.css','admin.js','account.html','account.css','account.js','profile.js','profile.css','theme.js','catalog.css','commerce.css','admin-extras.js','product.html','product.js','favorites.js','trust.js','security.js','assets/iphone-pro.jpg','assets/iphone-colors.jpg','assets/xiaomi.png','assets/playstation.png','assets/xbox.png','assets/fachada-up-smart.png']){
